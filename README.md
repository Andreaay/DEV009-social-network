...
Posibilidad de registrarse utilizando correo electrónico y contraseña.
Opción de registro y acceso rápido a través de cuentas de Google.

* Creación de Perfil Profesional:

Los usuarios pueden crear perfiles detallados que incluyen su nombre, foto de perfil y una descripción.
La descripción puede incluir información sobre experiencia musical, géneros, instrumentos dominados y otras habilidades relevantes.
Los perfiles permiten a los usuarios mostrar su trayectoria y habilidades musicales de manera profesional.

* Publicación de Contenido Personalizado:

Los usuarios pueden crear y compartir publicaciones personalizadas que incluyen texto.
Las publicaciones se muestran en un feed en orden cronológico inverso, mostrando las más recientes primero.
Los usuarios pueden editar y actualizar sus publicaciones después de haberlas creado.
Opción de dar "likes" a las publicaciones y ver el número total de "likes".

* Creación y Visualización de Eventos:

Los usuarios pueden crear eventos, especificando título, descripción, fecha y ubicación.
Los eventos creados se muestran en una sección dedicada, junto con detalles relevantes.
Los usuarios pueden indicar su interés en eventos y ver la lista de otros usuarios interesados.

* Personalización y Colores Temáticos:

Capacidad de personalizar la apariencia de la interfaz mediante la selección de colores temáticos.
Alternar entre dos diferentes esquemas de colores para una experiencia visual atractiva.

* Persistencia de Datos en tiempo real:

Todos los datos, perfiles, publicaciones y eventos se almacenan y actualizan en tiempo real en la base de datos, permitiendo una experiencia colaborativa y dinámica.


## 6. Tecnologías utilizadas

Las tecnologías utilizadas en el desarrollo de la red social "Expressio Music" están diseñadas para ofrecer una experiencia eficiente, segura y colaborativa para los usuarios, al tiempo que garantizan un rendimiento óptimo y una interfaz atractiva. Estas tecnologías se han seleccionado cuidadosamente para cumplir con los objetivos y requisitos específicos del proyecto. Algunas de las tecnologías clave utilizadas son:

* Firebase: Firebase se ha utilizado como plataforma integral para el backend de la aplicación. Proporciona una amplia gama de servicios, como autenticación de usuarios, almacenamiento de datos en tiempo real, hosting web y autenticación con Google. Firebase permite la gestión eficiente de datos y la interacción en tiempo real en toda la aplicación.

* Vite: Vite se ha elegido como el entorno de desarrollo para la construcción de la interfaz de usuario de la aplicación. Vite ofrece un entorno de desarrollo rápido y eficiente, permitiendo una rápida recarga en el navegador y un flujo de trabajo optimizado en el desarrollo frontend.

* Single Page Application (SPA): La arquitectura de aplicación de una sola página se ha implementado para garantizar una experiencia de usuario fluida y sin interrupciones. Esto permite que la aplicación funcione de manera eficiente, cargando solo los componentes necesarios cuando sea necesario y evitando la recarga completa de la página.

* HTML, CSS y JavaScript: Las tecnologías web fundamentales, como HTML para la estructura, CSS para el diseño y JavaScript para la interactividad, se han utilizado para construir la interfaz de usuario. Esto asegura que la aplicación sea accesible y funcione correctamente en una variedad de dispositivos y navegadores.

* Figma: Figma se ha empleado para diseñar tanto los prototipos de alta como baja fidelidad de la aplicación. Ha servido como herramienta para visualizar y iterar sobre la interfaz de usuario antes de la implementación, permitiendo una mejor comprensión de cómo interactuarán los usuarios con la aplicación y facilitando la identificación de posibles mejoras.

* Firestore: Firestore, la base de datos en tiempo real de Firebase, se ha utilizado para almacenar y sincronizar los datos de la aplicación, como perfiles de usuarios, publicaciones y eventos. Esto garantiza que la información esté disponible en tiempo real y se pueda acceder y actualizar de manera eficiente.

* Autenticación y Seguridad: Se ha implementado la autenticación de usuarios utilizando Firebase Authentication, lo que garantiza que solo los usuarios autorizados puedan acceder a la aplicación y sus funcionalidades. Se han implementado prácticas de seguridad para proteger los datos de los usuarios y prevenir vulnerabilidades.

* Git y GitHub: Se ha utilizado Git como sistema de control de versiones para rastrear y gestionar el código fuente. GitHub se ha empleado para alojar el repositorio de código, permitiendo la colaboración entre desarrolladores, la revisión de código y la gestión de problemas y solicitudes de funciones.
